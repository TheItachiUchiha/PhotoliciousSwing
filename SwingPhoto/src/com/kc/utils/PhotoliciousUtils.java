...
public class PhotoliciousUtils 
{
	...
	public static void main(String args[]) {
		...
		PhotoliciousUtils utils = new PhotoliciousUtils();
		utils.saveOutputFolder("C:\\Users\\HOME\\Pictures\\Google Talk Received Images");
		utils.saveConfiguration("Print","3r","3");
		System.out.println(utils.readDefaultPrinter());
		System.out.println(utils.readPrintSize());
		System.out.println(utils.readSlideTime());*/
	}
}